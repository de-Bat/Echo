...
# You can later expose key functions or classes here for easier imports, e.g.:
# from .base_scraper import BaseScraper
# from .scraper_manager import load_scrapers # If you create a manager

DEFAULT_USER_AGENT = "PriceTrackerBot/1.0 (+http://yourprojecturl.com/botinfo)"
